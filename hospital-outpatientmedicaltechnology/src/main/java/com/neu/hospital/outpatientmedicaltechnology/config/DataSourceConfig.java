package com.neu.hospital.outpatientmedicaltechnology.config;
...
public class DataSourceConfig {
    ...
    static final String PACKAGE = "com.neu.hospital.outpatientmedicaltechnology.dao";
    static final String MAPPER_LOCATION = "classpath:mapper/outpatientmedicaltechnology/*.xml";
    static final String ALIAS = "com.neu.hospital.outpatientmedicaltechnology.entity";
