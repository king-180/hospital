 ...
 */
@RestController
@RequestMapping("/outpatientdoctor/checkrelation")
public class CheckrelationController {
    ...
    public PageInfo<CheckRelation> list(@PathVariable Integer currPage, @RequestBody CheckRelation checkrelation) {
//        System.out.println(constantItem);
        return checkrelationService.list(currPage, checkrelation);
    }
