 ...
 */
@RestController
@RequestMapping("/outpatientdoctor/herbaldetailed")
public class HerbaldetailedController {
    ...
    public PageInfo<HerbalDetailed> list(@PathVariable Integer currPage, @RequestBody HerbalDetailed herbaldetailed) {
//        System.out.println(constantItem);
        return herbaldetailedService.list(currPage, herbaldetailed);
    }
