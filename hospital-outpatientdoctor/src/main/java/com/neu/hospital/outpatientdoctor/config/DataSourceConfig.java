package com.neu.hospital.outpatientdoctor.config;
...
public class DataSourceConfig {
    ...
    static final String PACKAGE = "com.neu.hospital.outpatientdoctor.dao";
    static final String MAPPER_LOCATION = "classpath:mapper/outpatientdoctor/*.xml";
    static final String ALIAS = "com.neu.hospital.outpatientdoctor.entity";
