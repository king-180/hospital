package com.neu.hospital.outpatientregistration.config;
...
public class DataSourceConfig {
    ...
    static final String PACKAGE = "com.neu.hospital.outpatientregistration.dao";
    static final String MAPPER_LOCATION = "classpath:mapper/outpatientregistration/*.xml";
    static final String ALIAS = "com.neu.hospital.outpatientregistration.entity";
