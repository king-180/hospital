package com.neu.hospital.outpatientfinancial.config;
...
public class DataSourceConfig {
    ...
    static final String PACKAGE = "com.neu.hospital.outpatientfinancial.dao";
    static final String MAPPER_LOCATION = "classpath:mapper/outpatientfinancial/*.xml";
    static final String ALIAS = "com.neu.hospital.outpatientfinancial.entity";
