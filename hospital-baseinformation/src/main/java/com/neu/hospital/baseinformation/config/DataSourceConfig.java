package com.neu.hospital.baseinformation.config;
...
public class DataSourceConfig {
    ...
    static final String PACKAGE = "com.neu.hospital.baseinformation.dao";
    static final String MAPPER_LOCATION = "classpath:mapper/baseinformation/*.xml";
    static final String ALIAS = "com.neu.hospital.baseinformation.entity";
