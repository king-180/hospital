package com.neu.hospital.outpatientpharmacy.config;
...
public class DataSourceConfig {
    ...
    static final String PACKAGE = "com.neu.hospital.outpatientpharmacy.dao";
    static final String MAPPER_LOCATION = "classpath:mapper/outpatientpharmacy/*.xml";
    static final String ALIAS = "com.neu.hospital.outpatientpharmacy.entity";
